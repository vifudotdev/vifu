      ...
      {choice ? (
        <form className="resource-dialog-shell" onSubmit={save}>
          ...
          <div className="resource-dialog-fields">
            ...
            {!provider && choice.source.kind === "custom" ? (
              <p>This provider is already configured in the runtime registry. Adding it only makes it available to this project.</p>
        ...
        <div className="resource-dialog-shell provider-picker-shell">
          ...
          <div className="provider-picker-list">
            ...
            <ProviderChoiceGroup title="Configured providers" items={filtered.filter((item) => item.source.kind === "custom")} onSelect={setChoice} />
