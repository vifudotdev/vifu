...
| --- | --- | --- |
| [`godot/apple`](godot/apple/) | Swift bridge between an embedded Vifu Runtime and a host-owned libgodot instance | [`examples/godot-ios-embedding`](../examples/godot-ios-embedding/) |
