...
local files, creates one permanent local App, connects the local Gateway, and
opens the live Runtime TUI in an interactive terminal. Press `B` to open the
Dashboard. Runtime and Gateway state use
