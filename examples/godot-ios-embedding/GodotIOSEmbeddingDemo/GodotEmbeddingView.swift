...
struct GodotEmbeddingView: View {
        ...
        ZStack(alignment: .bottom) {
            VStack(spacing: 0) {
                ...
                GodotRuntimeStage(
                    ...
                    runtimeBridge: viewModel.runtimeBridge
                )
...
private struct GodotEmbeddingHeader: View {
    let activity: String
    let onModelTap: () -> Void
