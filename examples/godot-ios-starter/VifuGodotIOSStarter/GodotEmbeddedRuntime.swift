...
final class GodotEmbeddedRuntime: @unchecked Sendable {
    static let projectID = "godot-ios-starter"
    ...
    private static func gatewaySupportDirectory() throws -> URL {
        ...
        let directory = root.appendingPathComponent("VifuGodotIOSStarter", isDirectory: true)
